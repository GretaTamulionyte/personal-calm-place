from calm_place_modes import MakeAudio, TextData, WriteTexts
...
def default_text():
    ...
    only_default_text = """
                ...
                that will help you feel refreshed and calm…these woods are quite special...
                a place where you can escape and feel safe…
                it’s your own private hideaway.  Pretend as if you’re there now.
