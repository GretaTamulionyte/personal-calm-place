...
that is unique to YOUR personal sense of calm.\n\n\n"
        ...
        while mode_running:
            ...
            if self.chosen_form == "f":
                self.create_freeform_text()
                mode_running = False

            if self.chosen_form == "g":
                self.create_guided_text()
                mode_running = False
...
you make in th program will be read out to you by a calming voice of your choosing \n\
that reads thecript back to you. For example, use sentences like 'You are resting on a light white cloud...'\n\n"
        )
        self.text = []
        prompts = [
    ...
    def generate_text_ai(self):
        ...
        prompt_for_script = f"""
            ...
            script WITHOUT any additional comments like "Here is the visualisation script."
            ...
            **Key Elements to Include:*
            ...
            - A gentle conclusion that brings the listener back to the present momen
            # Output Forma
